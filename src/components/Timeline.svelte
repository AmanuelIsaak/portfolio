...
let context = {
  ...
  whereDoIStandNow: {
    short: "I have programming experience mainly in Go and JavaScript (Svelte), with school exposure to PHP and Java. I've built some simple websites and decent apps but still feel like a beginner. I lack a deep understanding of software fundamentals, data structures, algorithms, and haven't developed a complex application that covers both frontend and backend, along with topics like security, networking, and design patterns.",
