...
import VimSVG from "../assets/neovim.svg"
    ...
    <div class="relative overflow-hidden bg-gray-900 py-8">
      <div class="flex flex-col">
        <div class="flex items-center space-x-8">
          <h1 class="flex items-center space-x-2 h-16 text-gray-900 dark:text-white">4<img src={StarSVG} alt="Languages"></h1>
        ...
        <div class="flex items-center space-x-8 mt-4">
          <h1 class="flex items-center space-x-2 h-16 text-gray-900 dark:text-white">3<img src={StarSVG} alt="Languages"></h1>
          <div class="flex space-x-8 animate-scroll">
        ...
        <div class="flex items-center space-x-8 mt-4">
          <h1 class="flex items-center space-x-2 h-16 text-gray-900 dark:text-white">2<img src={StarSVG} alt="Languages"></h1>
          <div class="flex space-x-8 animate-scroll">
