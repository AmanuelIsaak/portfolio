...
<section id="contact" class="relative py-24 md:py-32 px-6 overflow-hidden">
    <!-- Decorative blob -->
    <div class="absolute top-10 -left-32 w-72 h-72 bg-amber-200/15 dark:bg-amber-500/5 rounded-full blur-3xl animate-float"></div>

    <div class="relative max-w-5xl mx-auto">
        <ScrollReveal>
            <div class="max-w-xl">
                <p class="inline-block text-sm font-semibold mb-4 tracking-wide uppercase px-3 py-1 rounded-full bg-rose-50 dark:bg-rose-900/30 text-rose-600 dark:text-rose-400 border border-rose-200/50 dark:border-rose-700/50">
                    Contact
                </p>
                ...
                <p class="text-slate-600 dark:text-slate-400 leading-relaxed mb-10">
                    ...
                    say hello. I'm always open to new opportunities and conversations.
                </p>
                ...
                <div class="flex flex-wrap gap-4">
                    <a
                        ...
                        class="group inline-flex items-center gap-2 px-5 py-2.5 rounded-lg border border-slate-200 dark:border-slate-700 text-slate-700 dark:text-slate-300 hover:bg-slate-900 dark:hover:bg-white hover:text-white dark:hover:text-slate-900 hover:border-slate-900 dark:hover:border-white transition-all duration-300 text-sm font-medium"
                    >
                    ...
                    <a
                        ...
                        class="group inline-flex items-center gap-2 px-5 py-2.5 rounded-lg border border-slate-200 dark:border-slate-700 text-slate-700 dark:text-slate-300 hover:bg-rose-600 hover:text-white hover:border-rose-600 dark:hover:bg-rose-600 dark:hover:border-rose-600 dark:hover:text-white transition-all duration-300 text-sm font-medium"
                    >
